...
// Todos os elementos que o JS manipula,
// agrupados no início para fácil consulta
// ========================================
...
const elTotalFornecedores     = document.getElementById("stat-total-fornecedores");
const elFornecedoresAtivos    = document.getElementById("stat-fornecedores-ativos");
const elFornecedoresInativos  = document.getElementById("stat-fornecedores-inativos");
const elFornecedoresPendentes = document.getElementById("stat-fornecedores-pendentes");
...
// o erro nativo do navegador — ID 11, ID 12
...
inputCnpj.addEventListener("input", () =>
  validarComRegex(inputCnpj, REGEX_CNPJ, "Informe um CNPJ válido, ex.: 00.000.000/0000-00")
);

inputTelefone.addEventListener("input", () =>
  validarComRegex(inputTelefone, REGEX_TELEFONE, "Informe um telefone válido, ex.: (42) 99999-9999")
);
